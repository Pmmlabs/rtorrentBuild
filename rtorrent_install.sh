...
wget http://web.archive.org/web/20150511050113/http://libtorrent.rakshasa.no/downloads/$libtorrent.tar.gz
wget http://web.archive.org/web/20150511050113/http://libtorrent.rakshasa.no/downloads/$rtorrent.tar.gz
